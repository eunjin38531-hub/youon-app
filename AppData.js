...
window.YuonData = (function () {
  ...
  const profiles = [
    {
      id: 'jihoon', name: '밥약속있음', age: 27, score: 70, activity: '오늘',
      photo: IMG.jihoon,
      sajuLine: '화목 조합, 에너지가 넘치는 인연',
      intro: '일단 만나서 먹으면서 얘기하기 좋아해요. 몸 쓰는 일을 해서...',
      bio: '일단 만나서 먹으면서 얘기하기 좋아해요. 몸 쓰는 일을 해서 체력은 자신 있어요. 솔직하고 에너지 넘치는 사람이에요.',
      sajuTag: '에너지 넘치고 솔직해요',
      district: '마포구', height: 180, smoke: '비흡연', drink: '즐김',
      job: '자동차 정비사', school: '한국기술대',
      element: '화(火)가 밝은 여름의 기운',
      sajuKeywords: ['화목 상생', '에너지 폭발', '솔직한 매력'],
      synergy: '화(火)와 목(木)이 만나 서로를 키워주는 상생 관계예요. 함께 있으면 활기차고 즐거운 시간이 가득해요.',
      impressions: ['솔직해요', '에너지 넘쳐요', '유쾌해요'],
    ...
    },
    {
      ...
      intro: '새벽 감성으로 이것저것 계획 세우는 게 즐거워요',
